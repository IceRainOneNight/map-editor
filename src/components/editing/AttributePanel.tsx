...
export default function AttributePanel() {
  ...
  if (mode === 'empty') {
    return (
      <div className="attr-panel">
        <div className="attr-panel-header">属性</div>
  ...
  if (mode === 'feature') {
    ...
    const canEditNodes =
      featType === 'LineString' || featType === 'Polygon';

    return (
      <div className="attr-panel">
        <div className="attr-panel-header">
          要素属性
          <span className="attr-type-badge">{featType}</span>
        </div>
  ...
  return (
    <div className="attr-panel">
      <div className="attr-panel-header">
        图层属性
        <span className="attr-type-badge">{layer.name}</span>
      </div>
      <div className="attr-body">
        {/* 图层名称 */}
